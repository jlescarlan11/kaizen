...
export function AuthenticatedLayout(): ReactElement {
  ...
  const navItems = [
    ...
    { label: 'Budget', to: '/budget', icon: <BudgetIcon /> },
    { label: 'Add Entry', to: '/add', icon: <AddIcon />, isAction: true },
    { label: 'Goal', to: '/goal', icon: <GoalIcon /> },
    { label: 'Vault', to: '/vault', icon: <VaultIcon /> },
  ]
