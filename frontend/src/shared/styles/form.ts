...
export const formFieldClasses = {
  ...
  input: cn(
    'h-14 w-full rounded-[1.25rem] border-2 border-border-subtle bg-surface px-4 text-base font-black tracking-tight text-text-primary outline-none transition-all',
