...
export function UndoSnackbar({ offset = 'standard' }: UndoSnackbarProps): ReactElement | null {
  ...
  return (
    ...
    >
      <Card className="bg-surface-secondary border-border shadow-2xl p-4 flex items-center justify-between animate-entrance-slide-up rounded-2xl overflow-hidden">
