  ...
  return (
    <div className="p-5 rounded-2xl bg-surface border border-border-subtle shadow-sm flex flex-col group h-full overflow-hidden">
      <div className="flex items-center justify-between mb-3">
        ...
        <span className="text-[10px] font-medium text-text-secondary bg-surface-secondary px-2 py-0.5 rounded-full">
      ...
      <div className="mb-4">
        <div className="flex justify-between items-center mb-1.5">
          <p className="text-[10px] font-medium text-text-tertiary/60">Liquidity Split</p>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        ...
        >
          ...
          <span className="text-[11px] font-medium">Link New</span>
        </button>
      </div>
    </div>
  )
