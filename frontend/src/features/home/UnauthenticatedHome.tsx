  ...
  return (
    <div className="w-full space-y-12 md:space-y-24">
      ...
      >
        ...
        <p
          className={`animate-fade-up ${typography.caption} tracking-wide uppercase mb-4 [animation-delay:0.05s]`}
        >
          Filipino Student Finance
        </p>

        {/* Role: display (hero headline) */}
        <h1 className={`animate-fade-up ${typography.display} mb-6 [animation-delay:0.12s]`}>
          STOP SAYING{' '}
        ...
        <p
          className={`animate-fade-up max-w-2xl mx-auto md:mx-0 ${typography['body-lg']} mb-8 [animation-delay:0.22s]`}
        >
        ...
        <div className="animate-fade-up flex flex-col items-center md:flex-row md:items-center gap-3 [animation-delay:0.38s]">
          <div className="flex justify-center md:justify-start" aria-hidden="true">
            ...
            <div className="-ml-2 z-20 h-8 w-8 rounded-full border-2 border-background bg-surface-secondary flex items-center justify-center text-xs font-semibold text-text-primary shrink-0">
              MR
            </div>
            <div className="-ml-2 z-30 h-8 w-8 rounded-full border-2 border-background bg-surface-secondary flex items-center justify-center text-xs font-semibold text-text-primary shrink-0">
              AK
            </div>
          </div>
          {/* Role: body-sm (metadata) */}
          <p className={typography['body-sm']}>
            Joined by <strong className="font-semibold text-text-primary">2,400+ students</strong>{' '}
