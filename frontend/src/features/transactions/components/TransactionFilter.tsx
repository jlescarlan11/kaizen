    ...
    <Popover className="relative">
      {({ open }) => (
        <>
          ...
          >
            <PopoverPanel className="absolute right-0 z-50 mt-2 w-80 origin-top-right rounded-2xl border border-border bg-surface p-4 shadow-2xl focus:outline-none">
              <div className="space-y-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center gap-2 overflow-x-auto pb-1 scrollbar-none -mx-1 px-1">
                    {[
                      ...
                      <button
                        ...
                        className="flex-none flex items-center justify-center rounded-lg border border-border-subtle bg-surface-secondary px-3 py-2 text-xs font-semibold uppercase tracking-wider text-text-secondary hover:border-border transition-all whitespace-nowrap"
                      >
                        {preset.label}
                      </button>
                    ))}
                  ...
                  <div className="grid grid-cols-2 gap-3 pt-1">
                    <div className="space-y-1.5">
                      <label className="text-xs font-semibold text-text-secondary uppercase tracking-wide ml-1">
                        From
                      </label>
                      <input
                        type="date"
                        ...
                        className="w-full bg-surface-secondary border border-border-subtle rounded-lg px-2 py-1.5 text-xs font-medium text-text-primary focus:outline-none focus:border-primary transition-colors"
                      />
                    </div>
                    <div className="space-y-1.5">
                      <label className="text-xs font-semibold text-text-secondary uppercase tracking-wide ml-1">
                      ...
                      <button
                        ...
                        className={cn(
                          ...
                          filter.types.includes(type)
                            ...
                            : 'border-border-subtle bg-surface-secondary text-text-secondary hover:border-border',
                        )}
                      >
                ...
                <div className="space-y-3">
                  ...
                  <div className="max-h-40 overflow-y-auto space-y-1 pr-1 scrollbar-thin">
                    {categories.length === 0 ? (
                      <p className="text-sm text-text-secondary py-2 text-center italic">
                        No categories found
                      </p>
                    ) : (
                      categories.map((category) => (
                        <div
                          key={category.id}
                          className="flex items-center gap-3 p-2 rounded-lg hover:bg-surface-secondary transition-colors cursor-pointer group"
                        ...
                        >
                          ...
                          <div
                            ...
                            style={{
                              backgroundColor: withOpacity(category.color, 0.13),
                    ...
                    {paymentMethods.length === 0 ? (
                      ...
                      paymentMethods.map((pm) => (
                        ...
                        >
                          ...
                          />
                          <div className="flex h-6 w-6 items-center justify-center rounded-full bg-surface-secondary text-text-primary font-semibold text-xs">
